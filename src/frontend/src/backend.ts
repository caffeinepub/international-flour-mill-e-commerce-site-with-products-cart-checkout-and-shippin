...
import type { Category as _Category, Order as _Order, Product as _Product } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async placeOrder(arg0: Order): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.placeOrder(to_candid_Order_n11(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        customer: from_candid_record_n4(_uploadFile, _downloadFile, value.customer),
...
function from_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "oil" in value ? Category.oil : "blends" in value ? Category.blends : "spices" in value ? Category.spices : "sweets" in value ? Category.sweets : value;
}
...
function to_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        customer: to_candid_record_n13(_uploadFile, _downloadFile, value.customer),
        totalAmountCents: value.totalAmountCents,
        placedAt: value.placedAt,
        products: value.products
    };
